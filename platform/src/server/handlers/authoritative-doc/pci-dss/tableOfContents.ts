...
that are belongs to the requirements and their sections

Example output:
Build and Maintain a Secure Network and Systems, page 42
Requirement 1: Install and Maintain Network Security Controls, page 42
and so on

IMPORTANT:
- Return only sections that are belongs to the requirements.
