...
from ..processor.utils import extract_bookmarks
# Package Imports
...
async def zerox(
    ...
    **kwargs
    ...
    :param schema: JSON schema to enforce structured output format, defaults to None
    :type schema: Dict[str, Any], optional
    :param generation_id: Unique identifier for the generation, defaults to None
    :type generation_id: str, optional
    ...
    with tempfile.TemporaryDirectory() as temp_dir_:
        ...
        bookmarks = extract_bookmarks(local_path)
